...
{
    public class Store1CreateStockCommandHandler : IRequestHandler<Store1CreateStockCommandRequest, Store1CreateStockCommandResponse>
    {
        ...
        public async Task<Store1CreateStockCommandResponse> Handle(Store1CreateStockCommandRequest request, CancellationToken cancellationToken)
        {
            ...
            // Başarılı dönüş
            return new Store1CreateStockCommandResponse
            {
                Success = true,
