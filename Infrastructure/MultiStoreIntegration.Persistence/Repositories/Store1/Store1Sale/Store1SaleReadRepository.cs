...
{
    public class Store1SaleReadRepository : Store1ReadRepository<Sale>, Store1ISaleReadRepository
    {
        public Store1SaleReadRepository(Store1DbContext context) : base(context)
        {
        }
    }
}
