...
import {
    ...
    updateStock,
    deleteStock
} from '../../services/store2Service';
import authService from '../../services/authService';
import countryService from '../../services/countryService';

const Store2Operations = () => {
    ...
    useEffect(() => {
        const fetchStockList = async () => {
            try {
                ...
                if (response.success) {
                    setStockList(response.store2Stocks || []);
                }
            } catch (error) {
            ...
            switch (activeTab) {
                case 'stock':
                    ...
                    if (stockResponse.success) {
                        setStocks(stockResponse.store2Stocks || []);
                    } else {
                ...
                case 'sale':
                    ...
                    if (saleResponse.success) {
                        setSales(saleResponse.store2Sales || []);
                    } else {
                ...
                case 'return':
                    ...
                    if (returnResponse.success) {
                        setReturns(returnResponse.store2Returns || []);
                    } else {
...
export default Store2Operations; 